					...
					if (password_input.equals(confirmPassword_input)) {       //check if confirm password field is same as password field
						...
						handler.post(new Runnable() {
							...
							public void run() {
								...
								//PutData putData = new PutData("http://192.168.0.112/Android/signup.php", "POST", field, data);
								//https://bulacke.xyz/medpal-db/signup.php
								PutData putData = new PutData("https://bulacke.xyz/medpal-db/signup.php", "POST", field, data);
								if (putData.startPut()) {
